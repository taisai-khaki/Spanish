...
t('B1 is the main stage (806 items: 545w/180s/45g/4 dialogues, 36 lines)', run('engine.stats("B1").total') === 806
...
t('game pool total = 1151 items across A1–B2 (exam not counted)',
  run('engine.stats("A1").total + engine.stats("A2").total + engine.stats("B1").total + engine.stats("B2").total') === 1151);
